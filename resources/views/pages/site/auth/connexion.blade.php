...
Something is soo wrong
@endif
<div style="background:#48afeb31;"class=" h-screen">
    
    <section class="h-screen py-16">
        <div style=""class="bg-white  w-2/5 mx-auto  py-8">
        <h1 style=""class="text-center text-blue-darker font-bold text-2xl my-4">Connexion</h1>
        <form class="w-3/4 mx-auto rounded my-12 py-4" action="{{route('login')}}" method="POST">
            @csrf
