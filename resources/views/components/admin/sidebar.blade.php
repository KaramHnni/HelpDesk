<div style="width:15%; height:100vh;" class="bg-white">
    ...
    <li class="px-10  {{ request()->is('admin/dashboard') ? 'border-l-4 border-blue-dark border-solid bg-blue-lightest text-blue-dark font-bold ' : '' }} l"><a href="{{route('admin.dashboard')}}" class="   block py-4">Tableau de bord</a></li>
        <li class="px-10 {{ request()->is('admin/employees/*') || request()->is('admin/employees') ? 'border-l-4 border-blue-dark border-solid bg-blue-lightest text-blue-dark font-bold ' : '' }}"><a href="{{route('admin.employees')}}" class="   block py-4">Employés</a></li>
        <li class="px-10  {{ request()->is('admin/maintenances/*') || request()->is('admin/maintenances') ? 'border-l-4 border-blue-dark border-solid bg-blue-lightest text-blue-dark font-bold ' : '' }}"><a href="{{route('admin.maintenances')}}" class="block py-4">Maintenances</a></li>
